...
string tripleDESEncryption(string& bobKey){
    ...
    //copying key to decrypt for ElGamal
    bobKey = key;
    ...
    for(int i = 0; i<3; i++) {
        ...
        while(len > 0) {
            ...
            //add ciphertext to each round of DES
...
string tripleDESDecryption(string ciphertext){
    string bitBlock="", plainFromCiph = "";
    string asciiPlain="";
    string key, subKeys[16];
    int len;
